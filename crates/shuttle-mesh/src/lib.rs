...
use shuttle_core::{Event, EventFilter, EventStore, Result, ShuttleError};
...
mod tests {
    use super::*;
    use shuttle_core::{EventStore, EventType};
    ...
    fn bidirectional_sync_resumes_after_each_peer_records_events() {
        ...
        let memory = shuttle_memory::new_memory(
            "workspace".into(),
            "codex".into(),
            "session".into(),
        ...
        let handoff = shuttle_task::new_handoff(
            "workspace".into(),
            "codex".into(),
            "session".into(),
            "claude".into(),
        ...
        let message = shuttle_message::new_message(
            "workspace".into(),
            "claude".into(),
            "session".into(),
            "codex".into(),
